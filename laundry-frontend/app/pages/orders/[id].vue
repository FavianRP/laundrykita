...
<template>
    ...
    <div v-else-if="error && !order" class="text-sm text-[var(--color-stamp)]">
        {{ error }}
    </div>
    ...
    <div v-else-if="order" class="max-w-3xl pb-20">
        ...
        <div
            ...
            class="mb-6 rounded-lg bg-[var(--color-pending-light)] px-4 py-3 flex items-center justify-between flex-wrap gap-2"
        >
        ...
        >
            ...
            <p v-else class="mt-4 text-sm text-[var(--color-go)] font-medium">
        ...
        >
            <button
                @click="openEditForm"
                class="text-sm px-4 py-2 rounded-md border border-[var(--color-line)] bg-white text-[var(--color-ink)] hover:border-[var(--color-soap)] transition-colors"
            >
                Ajukan Perbaikan Data
            </button>
            <button
                @click="showCancelForm = true"
                class="text-sm px-4 py-2 rounded-md border border-[var(--color-stamp)] text-[var(--color-stamp)] hover:bg-[var(--color-stamp)] hover:text-white transition-colors"
            >
                Ajukan Pembatalan
            </button>
        </div>
        ...
        >
            <div
                class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6 overflow-y-auto max-h-[90vh]"
            >
                <h3 class="font-display text-xl text-[var(--color-ink)] mb-4">
                    Ajukan Perbaikan Data
                </h3>
                ...
                >
                    <p class="text-xs font-mono mb-2">Item #{{ idx + 1 }}</p>
                ...
                <div class="mb-5">
                    <label
                        class="block text-xs text-[var(--color-ink-soft)] mb-1"
                        >Alasan Perbaikan
                        <span class="text-[var(--color-stamp)]">*</span></label
                    >
                    <textarea
                        v-model="editReason"
                        rows="2"
                ...
                <div class="flex justify-end gap-2">
                    <button
                        ...
                        class="text-sm px-4 py-2 text-[var(--color-ink-soft)]"
                    >
                        Batal
                    </button>
                    <button
                        ...
                        class="text-sm px-4 py-2 bg-[var(--color-soap)] text-white rounded-md disabled:opacity-50"
                    >
                        {{ submittingEdit ? "Mengirim..." : "Kirim Pengajuan" }}
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button
                        ...
                        class="text-sm px-4 py-2 bg-[var(--color-stamp)] text-white rounded-md disabled:opacity-50"
                    >
                        {{
                            submittingCancel
                                ? "Mengirim..."
